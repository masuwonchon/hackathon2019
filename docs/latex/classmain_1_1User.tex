...
\begin{DoxyCode}{0}
\DoxyCodeLine{46     \textcolor{keyword}{def }\_\_init\_\_(self, **kwargs):}
\DoxyCodeLine{47         super(User, self).\_\_init\_\_(**kwargs)}
\DoxyCodeLine{48         \textcolor{keywordflow}{if} self.otp\_secret \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{49             \textcolor{comment}{\# generate a random secret}}
\DoxyCodeLine{50             self.otp\_secret = base64.b32encode(os.urandom(10)).decode(\textcolor{stringliteral}{'utf-\/8'})}
\DoxyCodeLine{51 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{67     \textcolor{keyword}{def }get\_totp\_uri(self):}
\DoxyCodeLine{68         \textcolor{keywordflow}{return} \textcolor{stringliteral}{'otpauth://totp/2FA-\/Demo:\{0\}?secret=\{1\}\&issuer=2FA-\/Demo'}.format(self.username, self.otp\_secret)}
\DoxyCodeLine{69 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{53     \textcolor{keyword}{def }password(self):}
\DoxyCodeLine{54         \textcolor{keywordflow}{raise} AttributeError(\textcolor{stringliteral}{'password is not a readable attribute'})}
\DoxyCodeLine{55 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{57     \textcolor{keyword}{def }password(self, password):}
\DoxyCodeLine{58         self.password\_hash = generate\_password\_hash(password)}
\DoxyCodeLine{59 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{63     \textcolor{keyword}{def }\mbox{\hyperlink{namespaceloginhashblock_aa5bb94484a68d0bbebce23b4cfeeb4b7}{verify\_loginhashblock}}(self, LoginHB):}
\DoxyCodeLine{64         loginhashblock = self.Lhashblock.split(\textcolor{stringliteral}{','})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{60     \textcolor{keyword}{def }verify\_password(self, password):}
\DoxyCodeLine{61         \textcolor{keywordflow}{return} check\_password\_hash(self.password\_hash, password)}
\DoxyCodeLine{62 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{70     \textcolor{keyword}{def }verify\_totp(self, token):}
\DoxyCodeLine{71         \textcolor{keywordflow}{return} onetimepass.valid\_totp(token, self.otp\_secret)}
\DoxyCodeLine{72 }
\DoxyCodeLine{73 @lm.user\_loader}
